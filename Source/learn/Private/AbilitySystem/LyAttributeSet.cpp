...
{
	const FLyGameplayTags& GameplayTags = FLyGameplayTags::Get();
...
void ULyAttributeSet::PostGameplayEffectExecute(const FGameplayEffectModCallbackData& Data)
{
	...
	if (Data.EvaluatedData.Attribute == GetHealthAttribute())
	{
		...
		UE_LOG(LogTemp,Warning,TEXT("damage is used on %s,the number is %f"),*Props.TargetAvatarActor->GetName(),GetHealth());
	}
